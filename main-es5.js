...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLeftSideLeftSideComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppLoadingLoadingComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"load-wrap\">\n  <div class=\"load-3\">\n      <div class=\"line\"></div>\n      <div class=\"line\"></div>\n      <div class=\"line\"></div>\n  </div>\n</div>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_main_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./service/main.service */
    "./src/app/service/main.service.ts");
    /* harmony import */


    var _map_map_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./map/map.service */
    "./src/app/map/map.service.ts");
    /* harmony import */


    var _left_side_left_side_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _asymmetrik_ngx_leaflet_markercluster__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _map_map_component__WEBPACK_IMPORTED_MODULE_5__["MapComponent"], _left_side_left_side_component__WEBPACK_IMPORTED_MODULE_8__["LeftSideComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_11__["FooterComponent"], _loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _asymmetrik_ngx_leaflet__WEBPACK_IMPORTED_MODULE_9__["LeafletModule"].forRoot(), _asymmetrik_ngx_leaflet_markercluster__WEBPACK_IMPORTED_MODULE_10__["LeafletMarkerClusterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_13__["FormsModule"]],
  ...
  /***/
  function srcAppLeftSideLeftSideComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLeftSideLeftSideComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function LeftSideComponent(mainService, mapService) {
        var _this = this;
        ...
        this.mainService.data$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.onDestroy)).subscribe(function (res) {
          _this.allMaskData = res;
        });
        this.mainService.saveFavorite$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.onDestroy)).subscribe(function (res) {
          _this.favoriteList = res;
        });
      }

      _createClass(LeftSideComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "maskFilterToggle",
        value: function maskFilterToggle() {
          this.maskFilterShow = !this.maskFilterShow;
        }
      }, {
        key: "setMaskOption",
        value: function setMaskOption(type) {
        ...
        value: function startSearch() {
          ...
          var result = [];
          this.errorStr = '';
          var cleanValue = this.searchValue.trim();
          ...
          this.allMaskData.forEach(function (item) {
            if (item.properties.address.includes(cleanValue) || item.properties.name.includes(cleanValue)) {
              if (_this2.maskOption === '全部') {
                result.push(item);
              }

              if (item.properties.mask_child !== 0 && _this2.maskOption === '兒童口罩') {
                result.push(item);
              }

              if (item.properties.mask_adult !== 0 && _this2.maskOption === '成人口罩') {
                result.push(item);
              }
            }
          });
        ...
        key: "goTarget",
        value: function goTarget(lat, lng) {
        ...
        value: function toggleFavorite(id) {
          ...
          var index = this.favoriteList.indexOf(id);
        ...
        key: "favoriteCheck",
        value: function favoriteCheck(id) {
        ...
        key: "toggleFavoriteList",
        value: function toggleFavoriteList() {
        ...
        key: "showFavorite",
        value: function showFavorite() {
          var _this3 = this;

          this.allFavoriteList = this.allMaskData.filter(function (v) {
            return _this3.favoriteList.includes(v.properties.id);
          });
    ...
    LeftSideComponent.ctorParameters = function () {
      return [{
        type: _service_main_service__WEBPACK_IMPORTED_MODULE_2__["MainService"]
      }, {
    ...
    LeftSideComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-left-side',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./left-side.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/left-side/left-side.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./left-side.component.scss */
      "./src/app/left-side/left-side.component.scss")).default]
    })], LeftSideComponent);
    /***/
  },
  ...
  function srcAppMapMapComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function MapComponent(mainService, mapService) {
        var _this4 = this;
        ...
        this.onDestroy = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
        this.mainService.data$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.onDestroy)).subscribe(function (res) {
          _this4.allMaskData = res;

          _this4.mapService.generateData(res);

          _this4.mainService.loading = false;
        });
      }
  ...
  function srcAppMapMapServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var leaflet_markercluster__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! leaflet.markercluster */
    "./node_modules/leaflet.markercluster/dist/leaflet.markercluster-src.js");
    /* harmony import */


    var leaflet_markercluster__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(leaflet_markercluster__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */


    var _service_main_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../service/main.service */
    "./src/app/service/main.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function MapService(mainService) {
      ...
      _createClass(MapService, [{
        key: "generateData",
        value: function generateData(maskData) {
          this.markerClusterData = this.generateMarker(maskData);
        }
      }, {
        key: "generateMarker",
        value: function generateMarker(maskData) {
          var data = [];
          ...
          maskData.forEach(function (item) {
            data.push(leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([item.geometry.coordinates[1], item.geometry.coordinates[0]], {
              icon: icon
            }).bindPopup("\n            <div class=\"heading\">".concat(item.properties.name, "</div>\n            <div class=\"detail\">\n              <img src=\"assets/images/icons/map-marker-alt-solid.svg\">\n              ").concat(item.properties.address, "\n            </div>\n            <div class=\"detail\">\n            <img src=\"assets/images/icons/phone.svg\">\n              ").concat(item.properties.phone, "\n            </div>\n            <div class=\"mask-detail-wrap\">\n              <span class=\"mask-adult\">\u6210\u4EBA\u53E3\u7F69\uFF1A").concat(item.properties.mask_adult, "</span>\n              <span class=\"mask-child\">\u5C0F\u5B69\u53E3\u7F69\uFF1A").concat(item.properties.mask_child, "</span>\n            </div>\n            <div class=\"detail update-time\">\n              \u6B64\u8CC7\u6599\u66F4\u65B0\u6642\u9593\uFF1A").concat(item.properties.updated, "\n            </div>\n          ")));
          });
          return data;
        }
      }, {
        ...
        value: function getUserLocation() {
          ...
          if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
              _this5.map.panTo(new leaflet__WEBPACK_IMPORTED_MODULE_2__["LatLng"](position.coords.latitude, position.coords.longitude));
            });
          }
        }
      }, {
        key: "changeLocation",
        value: function changeLocation(lat, lng) {
  ...
  function srcAppServiceMainServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MainService, [{
        ...
        value: function getData() {
          ...
          this.http.get(this.maskUrl).subscribe(function (res) {
            _this6.loading = true;
            _this6.updateTime = Date.now();

            _this6.data.next(res['features']);
        ...
        value: function autoRefresh() {
          ...
          this.autoTimer = setTimeout(function () {
            // that.autoRefresh();
            that.refreshMaskData(); // 10分鐘更新一次
          }, 600000);
        }
      }, {
        key: "refreshMaskData",
        value: function refreshMaskData() {
          this.getData();
        }
      }, {
        key: "toggleLeftSide",
        ...
        key: "getFavoriteCookie",
        value: function getFavoriteCookie() {
          var tmp = this.getCookie('Favorite_');
          var arr = tmp.split('@');
          var newArray = [];
          console.log(tmp);
        ...
        value: function getCookie(name) {
          ...
          var result;
          allCookieArray.forEach(function (item) {
            while (item.charAt(0) === ' ') {
        ...
        key: "updateFavorite",
        value: function updateFavorite(id) {
          var favoriteArray = this.saveFavorite.value;
        ...
        key: "updateFavoriteCookie",
        value: function updateFavoriteCookie() {
          var str = '';
          this.saveFavorite.value.forEach(function (item) {
            str += item + '@';
          });
        ...
        key: "removeFavorite",
        value: function removeFavorite(index, id) {
          var favoriteArray = this.saveFavorite.value;
    ...
    MainService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], MainService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/andytsai/project/mask-map-andy/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
